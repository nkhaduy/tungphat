...
const cncCapabilities: { title: string; description: string; icon: LucideIcon }[] = [
  { title: "Cắt theo kích thước", description: "Đối chiếu danh sách chi tiết, vật liệu và độ dày đã xác nhận.", icon: ScanLine },
  { title: "Khoan liên kết", description: "Kiểm tra vị trí, đường kính và mặt gia công từ thông tin kỹ thuật.", icon: CircleDotDashed },
      ...
      <section id="vat-lieu" className="scroll-mt-24 bg-[#f7f9f6] py-16 lg:py-24">
        <div className="container-shell">
          <div className="flex flex-col justify-between gap-6 lg:flex-row lg:items-end">
            <SectionIntro eyebrow="Vật liệu đang giới thiệu" title="Danh mục vật liệu chính" description="Các trang chi tiết và hình ảnh dưới đây được nối tới nội dung đã có trong website; mã hàng và tình trạng cung cấp được xác nhận khi trao đổi thực tế." />
