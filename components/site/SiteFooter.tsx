    ...
    <footer className="border-t border-forest-900/10 bg-[#f7f8f5] text-copy">
      <div className="container-shell grid gap-10 py-11 sm:grid-cols-2 lg:grid-cols-[1.25fr_.7fr_.7fr_1.1fr] lg:py-12">
        <div>
          ...
          <p className="mt-5 max-w-sm text-sm leading-6 text-slate-700">
            <LocalizedText
              vi={business.footerDescription}
              en="Wood materials and CNC machining solutions for workshops, carpenters, architects, and business clients."
            />
          </p>
          <div className="mt-5 grid gap-2 text-sm text-slate-700">
            <a
              href={PHONE_HREF}
              className="inline-flex min-h-11 items-center gap-3 font-extrabold text-forest-950 hover:text-wood-600"
            >
            ...
            <a
              ...
              className="inline-flex min-h-11 items-center gap-3 hover:text-wood-600"
            >
              <Mail size={17} className="text-wood-600" aria-hidden="true" />
              {business.email}
            </a>
          </div>
        </div>
        <div>
          <h2 className="text-xs font-extrabold uppercase tracking-[.15em] text-forest-900">
            <LocalizedText vi="Vật liệu" en="Materials" />
          </h2>
          <nav
            aria-label="Danh mục vật liệu tại footer"
        ...
        <div>
          <h2 className="text-xs font-extrabold uppercase tracking-[.15em] text-forest-900">
            <LocalizedText vi="Dịch vụ" en="Services" />
          </h2>
          ...
          <nav
            ...
            className="mt-5 grid gap-1 text-xs text-slate-600"
          >
            <Link
              href="/chinh-sach-bao-mat"
              className="flex min-h-11 items-center hover:text-wood-600"
            >
              <LocalizedText vi="Chính sách bảo mật" en="Privacy Policy" />
            </Link>
            <Link
              href="/dieu-khoan-su-dung"
              className="flex min-h-11 items-center hover:text-wood-600"
            >
              <LocalizedText vi="Điều khoản sử dụng" en="Terms of Use" />
            </Link>
          </nav>
        </div>
        <div>
          <h2 className="text-xs font-extrabold uppercase tracking-[.15em] text-forest-900">
            <LocalizedText vi="Hệ thống chi nhánh" en="Branch locations" />
          </h2>
          ...
          <TrackedLink
            ...
            className="pressable mt-4 inline-flex min-h-12 items-center justify-center gap-2 bg-wood-500 px-5 text-sm font-extrabold text-white hover:bg-wood-600"
          >
      ...
      <div className="bg-forest-950 py-4 text-white">
        <div className="container-shell flex flex-col gap-2 text-xs text-white/85 sm:flex-row sm:items-center sm:justify-between">
          <span>
            © 2026 {business.businessName} · MST {business.taxId}
          </span>
          <Link
            href="/"
            className="min-h-11 content-center hover:text-orange-200"
          >
            mdftungphat.com
          </Link>
        </div>
