      ...
      <SiteShell>
        ...
        <section data-answer-block className="border-b border-forest-900/10 bg-[#edf4ef] py-8" aria-labelledby="direct-answer-title">
          <div className="container-shell max-w-4xl">
            ...
            <p className="mt-3 text-base leading-8 text-slate-700">{localCopy?.answerDescription ?? `${page.excerpt} Tùng Phát cần kiểm tra vật liệu, file, kích thước, số lượng và hạng mục gia công trước khi xác nhận khả năng và báo giá.`}</p>
          </div>
        </section>
