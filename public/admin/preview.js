  ...
  const Preview = createClass({
    render: function () {
      ...
      return h("main", { style: { fontFamily: "Arial, sans-serif", maxWidth: "860px", margin: "0 auto", padding: "32px", color: "#16211b" } },
        ...
        data.get("featuredImage") ? h("img", { src: data.get("featuredImage"), alt: data.get("featuredImageAlt") || "", style: { width: "100%", maxHeight: "480px", objectFit: "cover", margin: "24px 0" } }) : null,
