...
export function QuotePreviewPage({ admin = false }: { admin?: boolean }) {
  ...
  const isPaid = quote.totals.grandTotal > 0 && quote.totals.remainingAmount === 0;
  ...
  return (
    <div>
      <div className="no-print">
        <PageHeader title={`Báo giá ${quote.quoteNumber}`} description="Bản xem trước nội bộ. File PDF chính thức được tạo và lưu phiên bản ở server." actions={<StatusBadge status={quote.status} />} />
