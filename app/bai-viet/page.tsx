...
export function generateMetadata(): Metadata {
  const indexability = getListingIndexability(getPublishedArticles().length);
    ...
    <>
      ...
      <main className="min-h-[70vh] bg-[#f6f7f5] pt-[72px]">
        ...
        <section className="py-16 lg:py-24"><div className="container-shell">
          {articles.length === 0 ? <div className="border border-forest-900/10 bg-white p-8"><h2 className="text-xl font-extrabold text-forest-950">Chưa có bài viết được xuất bản</h2><p className="mt-3 text-slate-600">Các bản nháp hiện vẫn đang được kiểm tra và chưa xuất hiện trên website.</p></div> : (
