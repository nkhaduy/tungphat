...
export default function ContactPage() {
  return (
    <>
      ...
      <SiteShell>
        <PageHero breadcrumbs={[{ label: "Trang chủ", href: "/" }, { label: "Liên hệ" }]} eyebrow="Tùng Phát tại Thủ Đức" title="Liên hệ Tùng Phát tại Thủ Đức" description={staticPages.contactIntro} image={{ src: locations[0].image, alt: locations[0].imageAlt, priority: true }} actions={<><TrackedLink href={ZALO_URL} target="_blank" rel="noopener noreferrer" eventName="click_zalo" eventProperties={{ location: "contact_hero" }} className="pressable inline-flex min-h-14 items-center justify-center gap-2 bg-wood-600 px-6 text-sm font-extrabold text-white hover:bg-wood-700"><MessageCircle size={18} aria-hidden="true" />Liên hệ Zalo</TrackedLink><a href="#branch-locations" className="pressable inline-flex min-h-14 items-center justify-center gap-2 border border-forest-900/20 bg-white px-6 text-sm font-extrabold text-forest-950">Xem hai chi nhánh</a></>} />
