...
const serviceSchema = { "@context": "https://schema.org", "@type": "Service", "@id": serviceId, name: "Gia công CNC gỗ theo yêu cầu", serviceType: "Gia công CNC ván gỗ", description: "Cắt, khoan, soi rãnh và gia công chi tiết ván gỗ theo kích thước hoặc file kỹ thuật.", url: absolutePageUrl("/gia-cong-cnc"), provider: { "@id": `${SITE_URL}/#organization` } };
const pageSchema = webPageSchema({ path: "/gia-cong-cnc", name: "Gia công CNC gỗ theo yêu cầu", description: "Tùng Phát nhận cắt, khoan, soi rãnh và gia công CNC ván gỗ theo kích thước hoặc file kỹ thuật.", primaryEntityId: serviceId });
  ...
  return (
    <>
      ...
      <SiteShell>
        ...
        <section data-answer-block className="border-b border-forest-900/10 bg-[#edf4ef] py-8" aria-labelledby="cnc-answer-title"><div className="container-shell max-w-4xl"><p className="text-xs font-extrabold uppercase tracking-[.15em] text-wood-600">Trả lời nhanh</p><h2 id="cnc-answer-title" className="mt-2 text-2xl font-extrabold text-forest-950">Dịch vụ CNC của Tùng Phát nhận những gì?</h2><p className="mt-3 text-base leading-8 text-slate-700">Tùng Phát tiếp nhận cắt, khoan, soi rãnh và gia công chi tiết ván gỗ theo kích thước, file kỹ thuật hoặc bản phác thảo. Khả năng thực hiện và báo giá phụ thuộc vào vật liệu, độ dày, số lượng và nội dung file được kiểm tra trước khi chạy máy.</p></div></section>
