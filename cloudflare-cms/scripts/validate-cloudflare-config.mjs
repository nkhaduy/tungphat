...
if (migrations.join(",") !== "0001_create_leads.sql,0002_lead_status_history_triggers.sql,0003_add_request_context.sql") errors.push("Phải giữ đúng 3 migrations đã duyệt.");
